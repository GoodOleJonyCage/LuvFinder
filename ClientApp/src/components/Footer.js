                                ...
                                <div className="footer-middle-item-wrapper">
                                    <div className="footer-middle-item mb-lg-0">
                                        ...
                                        <div className="fm-item-content">
                                            ...
                                            <img src="./assets/images/footer/about.jpg" alt="" className="footer-abt-img" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div className="fm-item-content">
                                            <div className="fm-item-widget lab-item">
                                                <div className="lab-inner">
                                                    <div className="lab-thumb">
                                                        <a href="/#">
                                                            <img src="./assets/images/footer/01.jpg"
                                                    ...
                                                    <div className="lab-content">
                                                        <h6>
                                                            <a href="blog-single.html">
                                                                Enable Seamin Matera Forin And Our
                                                                Orthonal Create Vortals.
                                                            </a>
                                                        </h6>
                                                        <p>July 23, 2021</p>
                                                    </div>
                                            ...
                                            <div className="fm-item-widget lab-item">
                                                <div className="lab-inner">
                                                    <div className="lab-thumb">
                                                        <a href="/#">
                                                            <img src="./assets/images/footer/02.jpg"
                                                                alt="footer-widget-img" />
                                                        </a>
                                                    </div>
                                                    <div className="lab-content">
                                            ...
                                            <div className="fm-item-widget lab-item">
                                                <div className="lab-inner">
                                                    <div className="lab-thumb">
                                                        <a href="/#">
                                                            <img src="./assets/images/footer/03.jpg"
                                                                alt="footer-widget-img" />
                                                        </a>
                                                    </div>
                                                    <div className="lab-content">
                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="footer-bottom-content text-center">
                                    <p>&copy; 2022 <a href="/">TuruLav</a> -Best For Dating HTML Template.</p>
                                </div>
                            </div>
                        </div>
                    </div>
